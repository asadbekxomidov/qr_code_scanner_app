...
//   Future<void> _saveScanData(String code, String timestamp) async {
//     final prefs = await SharedPreferences.getInstance();
//     final scanList = prefs.getStringList('scanHistory') ?? [];
//     scanList.add('$code, $timestamp');
//     await prefs.setStringList('scanHistory', scanList);
//   }
...
//                       DateFormat('yyyy-MM-dd HH:mm:ss').format(DateTime.now());
//                   await dbHelper.insertScan(code, timestamp);
//                   await _saveScanData(code, timestamp);
